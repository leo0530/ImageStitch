...
int lgy()
{
    Mat a = imread("d:\\2.png", 1);//右图
    Mat b = imread("d:\\1.png", 1);//左图
...
//逆时针旋转90度
Mat imageRatateNegative90(Mat src)
{
    Mat temp, dst;
    transpose(src, temp);
...
//int stitch()
//{
//    Mat a = imread("d:\\1.jpg", 1);//右图
//    Mat b = imread("d:\\2.jpg", 1);//左图

//  //  a = imageRatateNegative90(a);
//  //  b = imageRatateNegative90(b);
//    imshow("a",a);
//    imshow("b",b);
...
////    Mat a = imread("d:\\2.png", 1);//右图
////    Mat b = imread("d:\\1.png", 1);//左图
//    Mat a = imread("d:\\2.jpg", 1);//右图
//    Mat b = imread("d:\\1.jpg", 1);//左图
